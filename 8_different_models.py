...
paths_SSF =[#"checkpoint/SSF_PU_0504-150630/training.log",
            #"checkpoint/SSF_PU_0505-120343/training.log",
            #"checkpoint/SSF_PU_0505-095525/training.log"

        #"checkpoint/SSF_PU_0505-120343/training.log", # same training 1000 
        "checkpoint/SSF_PU_0505-134406/training.log" # same training 
    ]
